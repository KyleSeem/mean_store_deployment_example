...
var arr = [
    ...
    { name: 'Measuring Cups', description: 'Ceramic cat-shaped measuring cups', qty: 32, imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/71mP+awRmZL._AC_SR300,500_.jpg' },
...
prod.insertMany(arr, function(error, docs) {});
